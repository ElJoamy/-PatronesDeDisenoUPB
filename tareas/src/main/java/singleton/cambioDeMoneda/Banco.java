...
public class Banco {
    ...
    public void cambiarBolivianosADolares(double cantidad) {
        ...
        String[] extractos = EmpresaCambioDeMoneda.getInstance().imprimirExtracto("Banco", nombre, "Bs.", "$", cantidad, nuevaCantidad);
    ...
    public void cambiarDolaresAEuros(double cantidad) {
        ...
        String[] extractos = EmpresaCambioDeMoneda.getInstance().imprimirExtracto("Banco", nombre, "$", "€", cantidad, nuevaCantidad);
        System.out.println(extractos[0]);
        System.out.println(extractos[1]);
